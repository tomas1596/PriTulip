...
import song from '../assets/song.mp3'; // pon tu archivo de canción aquí
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50 p-4">
      ...
      <div 
        ...
        style={{
          backgroundImage: 'linear-gradient(45deg, rgba(251, 207, 232, 0.1) 25%, transparent 25%), linear-gradient(-45deg, rgba(251, 207, 232, 0.1) 25%, transparent 25%), linear-gradient(45deg, transparent 75%, rgba(251, 207, 232, 0.1) 75%), linear-gradient(-45deg, transparent 75%, rgba(251, 207, 232, 0.1) 75%)',
      ...
      >
        ...
        <div className="text-gray-700 leading-relaxed space-y-4">
          ...
          <div className="pl-4 py-3 rounded-r" style={{ color: '#0ec7f5ff' }}>
            <p>Pri ♥</p>
